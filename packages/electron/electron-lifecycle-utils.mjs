...
export const buildLinuxMenuTemplate = ({
  ...
  },
  {
    label: 'View',
    submenu: [
      { label: 'Toggle Right Sidebar', accelerator: menuAccelerator('linux', 'B'), click: () => dispatchAction('toggle-right-sidebar') },
      { label: 'Open Git Sidebar', accelerator: menuAccelerator('linux', 'Shift+G'), click: () => dispatchAction('open-right-sidebar-git') },
      { label: 'Open Files Sidebar', accelerator: menuAccelerator('linux', 'Shift+F'), click: () => dispatchAction('open-right-sidebar-files') },
      { type: 'separator' },
      { label: 'Toggle Terminal Dock', accelerator: menuAccelerator('linux', 'J'), click: () => dispatchAction('toggle-terminal') },
      { label: 'Toggle Terminal Expanded', accelerator: menuAccelerator('linux', 'Shift+J'), click: () => dispatchAction('toggle-terminal-expanded') },
      { type: 'separator' },
